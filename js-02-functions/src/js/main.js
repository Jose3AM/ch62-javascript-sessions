...
const printFullName2 = (firstName, lastName) => `${firstName} ${lastName} estudiante de la Ch62`;

console.log( printFullName2("Juan", "Gonzalez") );
...
console.log( makeCoffe() ); // Preparando un café Latte

// TODO: generar una función que calcule el área de un rectángulo
// usando parámetros por defecto para largo y ancho.

const rectangleArea = ( weight = 1, lenght = 1 ) => weight * lenght;
console.log( rectangleArea(5,5) );

console.log(`Vales 1000, estoy diciendo que vales: ${parseInt("1000", 10)}`); //decimal
console.log(`Vales 1000 base 2, estoy diciendo que vales: ${parseInt("1000", 2)}`) //binario
...
console.log(`Realizando una suma: ${calculate(6,3,(a, b) => a % b)}`); // Aplicar a la función calculate la función suma
